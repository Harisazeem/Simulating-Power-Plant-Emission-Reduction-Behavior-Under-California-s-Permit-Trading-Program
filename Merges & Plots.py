...
Tract_Demo_AllTracts.to_file("Tract_Demo_AllTracts.shp", layer="TractDemo")
...
##Post Project for Tableau
#read plants_tract as a shape file
plants_tracts.to_file("plants_tract.shp")
