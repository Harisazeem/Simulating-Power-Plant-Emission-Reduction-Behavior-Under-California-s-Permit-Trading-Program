...
*We use constant elasticity of demand function for the individual powerplants— which is then aggregated to find the market demand—as a stylized representation of individual permit trading behaviors under different elasticities. This helps us isolate the impact of elasticies (and through that MACs) on the power plant behavior*
