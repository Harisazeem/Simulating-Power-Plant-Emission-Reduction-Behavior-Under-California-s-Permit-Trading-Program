...
Relevant stakeholders can easily use the dashboard to see how their specific census tracts would respond in terms of percentage emission reductions based on different policy and elasticity scenarios. 
